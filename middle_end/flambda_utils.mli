...
(** Initial inlining stack for code not generated by inlining. *)
val empty_inlining_stack : Flambda.inlining_stack

(** The inlining stack to use when generating the body of a stub function. *)
val stub_inlining_stack : Flambda.inlining_stack

(** Combine two inlining stacks, where one is understood to be the original one
    on the application and the other comes from the environment. *)
val augment_inlining_stack
