...
(*| Deprecated --> alert "deprecated" *)    (*  3 *)
  ...
  | Non_monotonic_inlining_arguments of string  (* 69 *)
;;
...
let number = function
  ...
  | Match_on_mutable_state_prevent_uncurry -> 68
  | Non_monotonic_inlining_arguments _ -> 69
;;
...
let descriptions =
  [
    ...
    69, "Provided inlining arguments should be monotonics accross levels",
    ["Non_monotonic_inlining_arguments"];
  ]
;;
...
let message = function
  ...
  | Non_monotonic_inlining_arguments reason ->
    reason
;;
